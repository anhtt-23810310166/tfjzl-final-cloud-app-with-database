...
# -------------------------------------------------------------
# PHẦN CODE ĐƯỢC THÊM MỚI THEO YÊU CẦU CỦA ĐỒ ÁN (TASK 1)
# -------------------------------------------------------------
...
class Question(models.Model):
    ...
    # Method tính điểm dựa trên danh sách ID câu trả lời được chọn
...
class Choice(models.Model):
    ...
    choice_text = models.CharField(max_length=500, null=False)
